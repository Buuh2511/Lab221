...
public class StockDAO implements Serializable {
    ...
    public boolean createTable() throws Exception {
        ...
        try {
            String sql = "USE FU_DB;CREATE TABLE Stocks (StockID int NOT NULL PRIMARY KEY, StockName nvarchar(50), Address nvarchar(50), DateAvailable date, Note nvarchar(50));";
            conn = DBUtils.getMyConnection();
            preStm = conn.prepareStatement(sql);
            preStm.executeUpdate();
            check = true;           
