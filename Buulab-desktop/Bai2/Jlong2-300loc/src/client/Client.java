...
import model.ArmorInterface;
import server.ServerBuuh;
import support.MyValidation;
...
public class Client extends javax.swing.JFrame {
    ...
    private Vector<ArmorDTO> listArmor = null;
    private ArmorInterface server = null;
...
//            Vector dataTable = new Vector();
                ...
                if (!listArmor.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "List armor is empty");
                }
            } else {
                JOptionPane.showMessageDialog(this, "Server not founded");
            }
    ...
    private void setField(ArmorDTO armor) {
        ...
        String id = armor.getArmorID();
        for (int i = 0; i < listArmor.size(); i++) {
            if (id.equals(listArmor.get(i).getArmorID())) {
                position = i;
            }
        }
    }
            ...
            if (server != null) {
                ...
                if (validateArmor(armorID, classification, defense, description)) {
                    if (!"".equals(txtStatus.getText())) {
                        ...
                        JOptionPane.showMessageDialog(null, "Status can't empty");
                    }
        ...
        if (c1 == true) {
            if (server != null) {
                if (position != -1) {
                    ...
                    if (!matcher.matches()) {
                        JOptionPane.showMessageDialog(this, "date must be dd/mm/yy");
                        return;
                    }
                    //////////////////////
                    String defense = txtDefense.getText().trim();
