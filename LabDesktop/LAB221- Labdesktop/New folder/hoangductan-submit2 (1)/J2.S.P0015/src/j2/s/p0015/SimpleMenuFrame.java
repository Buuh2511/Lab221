...
public class SimpleMenuFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemTextIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/j2/s/p0015/icon.jpg"))); // NOI18N
        jMenuItemTextIcon.setMnemonic('b');
        jMenuItemTextIcon.setText("Both text and icon");
        jMenuSimple.add(jMenuItemTextIcon);

        jMenuItemIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/j2/s/p0015/icon.jpg"))); // NOI18N
        jMenuItemIcon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemIconActionPerformed(evt);
            }
        });
    ...
    private void jMenuItemIconActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemIconActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItemIconActionPerformed
