...
public class Main extends javax.swing.JFrame {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        for (int i = 0; i < listStock.size(); i++) {
            ...
            if (rs == false) {
                JOptionPane.showMessageDialog(this, "Can't import " + temp.getStockName());
            } else {
                JOptionPane.showMessageDialog(this, "Import " + temp.getStockName() + " successful");
            }

        }

        JOptionPane.showMessageDialog(this, "Insert finish");
